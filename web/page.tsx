    ...
    >
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ backgroundColor: "#0c0a08" }}>
          <FireCanvas />
          {/* Gradient overlay: dark top, transparent middle, dark vignette bottom */}
          <div
            className="absolute inset-0 pointer-events-none"
            style={{
              background:
                "linear-gradient(to bottom, rgba(12,10,8,0.72) 0%, rgba(12,10,8,0.1) 40%, rgba(12,10,8,0.5) 80%, rgba(12,10,8,0.85) 100%)",
            }}
          />
